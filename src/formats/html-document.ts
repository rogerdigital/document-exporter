...
export function markdownToBasicHtml(md: string): string {
	...
	// 2. Extract safe media tags generated by the attachment rewriter
	const mediaBlocks: string[] = [];
	html = html.replace(SAFE_MEDIA_TAG_RE, (match: string) => {
...
function renderEmbeddedImage(src: string, alt: string): string {
